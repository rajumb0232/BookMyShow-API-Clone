...
public class ScheduledTasks {
	 ...
	 * screenStatus to available booking status to expired ticket status to expired
	 * -- once the show gets completed ---------- get shows by showEndTime
	 * 
	 * *****************
	 * 
	 * method to reset the show status to ongoing
	 */
	@Scheduled(cron = "0 * * * * *")
	 ...
	 * 
	 * issue - if seat is booked to a show, then other shows cannot have the same
	 * seat even the show time is different
	 */
